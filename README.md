# :wave: Say hi to WOW DOLL :wave:

This project is created and intended to be used for the [Shopify Theme Development – with TailwindCSS](https://learningalone.com/)
